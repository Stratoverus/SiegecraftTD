...
func setup_main_menu():
	...
	# Try AAA layout first
	if has_node("MainContainer/SettingsPanel/SettingsContent/SettingsGrid/fullscreen"):
...
func _set_initial_focus():
	...
	# Try AAA layout first
	if has_node("MainContainer/LeftPanel/MainMenuContent/MainButtons/newGame"):
...
func update_medieval_profile_display():
	...
	if profile_manager and profile_manager.has_profile():
		...
		if has_node("ProfilePanel/ProfileContent/ProfileRank"):
...
func show_settings_menu():
	...
	if has_node("MainContainer/SettingsPanel"):
